...
export function LoginForm({ onLogin }: LoginFormProps) {
    ...
    return (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full rounded-md border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none focus:border-slate-400 focus:bg-white transition-colors"
                                required
                            />
                        </div>
         ...
         */}
                <div className="hidden md:flex justify-center items-center border-l ps-12 border-slate-100">
                    <div className="flex flex-col items-center opacity-80">
                        {/* Visual Circle Placeholder */}
                        <div className="h-40 w-40 rounded-full border-4 border-slate-800 p-2 flex items-center justify-center">
                            <div className="h-full w-full rounded-full border border-slate-800 flex items-center justify-center">
                                <span className="text-4xl">🏛️</span>
                            </div>
                        </div>
                        <h2 className="mt-6 text-center text-xl font-light tracking-widest text-slate-800 uppercase">
                            Univerzita<br />Komenského<br />v Bratislave
                        </h2>
                    </div>
                </div>
            </div>
