export function Header() {
    return (
        <header className="flex h-24 items-center justify-between border-b border-gray-200 bg-[#E8EBF0] px-8">
            <div>
                <h2 className="text-3xl font-bold text-[#2A2B47] text-indigo-900">Ahoj, Juraj</h2>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="h-10 w-10 overflow-hidden rounded-full bg-gray-300">
                    ...
                    <img src="https://ui-avatars.com/api/?name=Juraj&background=0D8ABC&color=fff" alt="Profile" />
                </div>
